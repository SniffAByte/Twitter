                        ...
                        <div class="post" v-for="(tweet, key) in tweets" :id="tweet.id">
                            ...
                            <div class="postContent">
                                <a :href="'{{route('user.show', '/')}}' + '/' + tweet.user.username" class="user">
                                    <img :src="(tweet.user.photo) ? '{{asset('/storage/photos')}}' + '/' + tweet.user.photo: 'https://abs.twimg.com/sticky/default_profile_images/default_profile_normal.png'">
                                </a>
                                <div class="data">
                            ...
                            <div class="content">
                                ...
                                <div class="someone">
                                    <a href="{{route('user.show', $suggestion->username)}}">
                                        <img src="{{$suggestion->photo ? asset('/storage/photos/' . $suggestion->photo) : env('DEFAULT_PHOTO')}}">
