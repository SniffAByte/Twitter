            ...
            <div class="row">
                <div class="d-xs-none d-sm-none d-md-block col-md-5 col-lg-3 left-bar">
                    ...
                    <div class="profileCard">
                        <a href="{{route('user.show', Auth::user()->username)}}" class="cover" {{ !is_null(Auth::user()->cover) ? "style=background:url('" . asset('/storage/covers/' . Auth::user()->cover) . "')": ''}}></a>
                        <div class="profileContent">
                            <a href="{{route('user.show', Auth::user()->username)}}">
                                <div class="avatar" {{!is_null(Auth::user()->photo) ? "style=background:url('" . asset('/storage/photos/' . Auth::user()->photo) . "')" : ''}}></div>
