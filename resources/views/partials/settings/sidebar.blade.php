...
<div class="profileCard">
    <a href="{{route('user.show', Auth::user()->username)}}" class="cover" style="background: {{ !is_null(Auth::user()->cover) ? 'url(' . asset('/storage/covers/' . Auth::user()->cover) . ')' : ''}}"></a>
    <div class="profileContent">
        <div class="avatar" style="background: {{ !is_null(Auth::user()->photo) ? 'url(' . asset('/storage/photos/' . Auth::user()->photo) . ')' : '' }}"></div>
