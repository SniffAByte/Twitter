            ...
            <div class="row" v-if="guys.length > 0">
                <div class="col-md-6 col-lg-3 ppl" v-for="(guy, key) in guys" :id="guy.id">
                    ...
                    <div class="profileCard">
                        <a :style="(guy.cover) ? 'background: url({{asset("/storage/covers/' + guy.cover + '")}})' : ''" :href="'{{route('user.show', '/')}}/' + guy.username" class="cover"></a>
                        <div class="profileContent">
                            <a :href="'{{route('user.show', '/')}}/' + guy.username">
                                <div class="avatar" :style="(guy.photo) ? 'background: url({{asset("/storage/photos/' + guy.photo + '" )}})' : 'background: url(https://abs.twimg.com/sticky/default_profile_images/default_profile_normal.png)'"></div>
