    ...
    <div class="container">
        ...
        @auth
            <div class="form-inline my-2 my-lg-0 navbar-form d-xs-none d-sm-none d-md-flex">
                ...
                <div class="dropdown">
                    <img id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" src="{{ !is_null(Auth::user()->photo) ? asset('/storage/photos/' . Auth::user()->photo) : env('DEFAULT_PHOTO')}}">
